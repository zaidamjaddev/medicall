...
const ServiceCard = ({ service, index }) => {
  ...
  return (
    <motion.div
      ...
      className="group relative bg-slate-800 rounded-2xl p-8 border border-slate-700 shadow-xl shadow-blue-500/10 hover:shadow-2xl hover:shadow-blue-500/20 transition-all duration-500 overflow-hidden"
    >
      <motion.div
      ...
      <div className="relative">
        ...
        <motion.h3
          ...
          viewport={{ once: true }}
          className="text-2xl font-bold text-slate-50 mb-4"
        >
          {service.title}
        </motion.h3>
    ...
    <>
      ...
      <section className="relative pt-32 pb-16 px-4 sm:px-6 lg:px-8 overflow-hidden bg-slate-900">
        ...
        <motion.div
          ...
          animate="animate"
          className="absolute top-20 left-10 w-96 h-96 bg-blue-500/20 rounded-full mix-blend-screen filter blur-3xl"
        />
        <motion.div
          variants={blobVariants}
          animate="animate"
          transition={{ delay: 1 }}
          className="absolute top-40 right-10 w-96 h-96 bg-emerald-500/20 rounded-full mix-blend-screen filter blur-3xl"
        />
        <motion.div
          variants={blobVariants}
          animate="animate"
          transition={{ delay: 2 }}
          className="absolute bottom-10 left-1/2 w-96 h-96 bg-blue-400/10 rounded-full mix-blend-screen filter blur-3xl"
        />
...
>
  Comprehensive AI Solutions for Healthcare
      ...
      {/* Services Grid */}
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-slate-900 to-slate-900">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-900">
        <div className="max-w-4xl mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
            className="relative bg-gradient-to-br from-blue-500 via-blue-600 to-emerald-500 rounded-3xl p-12 overflow-hidden shadow-2xl shadow-blue-500/20 group"
          >
